...
test('should merge coverage objects with branch hits', (t) => {
  const a = {
    ...
    branchMap: {
      0: {
        locations: [{ start: { line: 7, column: 2 }, end: { line: 7, column: 10 } }]
      }
    },
    statementMap: {},
    fnMap: {}
...
test('should merge coverage objects with different branch keys', (t) => {
  ...
  const b = {
    ...
    branchMap: {
      1: {
        locations: [{ start: { line: 8, column: 2 }, end: { line: 8, column: 10 } }]
      }
    },
    statementMap: {},
    fnMap: {}
...
test('should merge complex coverage with all types of hits and different keys (0-indexed)', (t) => {
  ...
  const b = {
    ...
    branchMap: {
      2: {
        locations: [{ start: { line: 13, column: 2 }, end: { line: 13, column: 10 } }]
      },
      1: {
        locations: [{ start: { line: 8, column: 1 }, end: { line: 8, column: 11 } }]
      }
    }
  }
  const expected = {
...
test('should merge branch hits where counts are uneven (first array longer) with valid locations', (t) => {
  const a = {
    ...
    branchMap: {
      0: {
        locations: [
          { start: { line: 7, column: 2 }, end: { line: 7, column: 10 } },
          { start: { line: 7, column: 12 }, end: { line: 7, column: 20 } },
          { start: { line: 8, column: 4 }, end: { line: 8, column: 8 } }
        ]
      }
    },
    statementMap: {},
...
test('should merge branch hits where counts are uneven (second array longer) with valid locations', (t) => {
  const a = {
    ...
    branchMap: {
      0: {
        locations: [
          { start: { line: 9, column: 1 }, end: { line: 9, column: 5 } },
          { start: { line: 10, column: 3 }, end: { line: 10, column: 7 } },
          { start: { line: 11, column: 0 }, end: { line: 11, column: 1 } }
        ]
      }
    },
    statementMap: {},
...
test('should merge branch hits with different lengths and keys with valid locations', (t) => {
  const a = {
    ...
    branchMap: {
      0: {
        locations: [
          { start: { line: 12, column: 2 }, end: { line: 12, column: 6 } },
          { start: { line: 12, column: 8 }, end: { line: 12, column: 12 } }
        ]
      },
      1: {
        locations: [{ start: { line: 13, column: 4 }, end: { line: 13, column: 8 } }]
      }
    },
    statementMap: {},
    fnMap: {}
  ...
  const b = {
    ...
    branchMap: {
      ...
      2: {
        locations: [
          { start: { line: 14, column: 1 }, end: { line: 14, column: 5 } },
          { start: { line: 14, column: 7 }, end: { line: 14, column: 11 } },
          { start: { line: 15, column: 3 }, end: { line: 15, column: 7 } }
        ]
      }
    },
    statementMap: {},
